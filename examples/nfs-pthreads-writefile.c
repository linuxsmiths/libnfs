 ...
 * Usually there will be one thread per context, but here we use more threads
 * to demonstrate that multiple threads can write to the same context.
 *
 * Note: Don't set very high number of threads else it's negatively impact
 *       performance.
 */
